// RUTA: libs/core/domain/shared-kernel/cdskmappers/eslint.config.mjs
...
export default tseslint.config(...baseConfig, {
  files: ['libs/core/domain/shared-kernel/cdskmappers/src/lib/**/*.ts'],
  ...
  rules: {
    // Reglas específicas para cdskmappers si son necesarias
  },
});
// RUTA: libs/core/domain/shared-kernel/cdskmappers/eslint.config.mjs
