...
const newApplicationTenancyFiles: FileToCreate[] = [
  ...
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/commands/set-tenant-db-config/set-tenant-db-config.command.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
  ...
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/use-cases/set-tenant-db-config/set-tenant-db-config.use-case.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/queries/get-tenant-details/get-tenant-details.query.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/queries/get-tenant-details/get-tenant-details.query-handler.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/queries/list-tenants/list-tenants.query.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/queries/list-tenants/list-tenants.query-handler.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
  ...
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/dtos/tenant-summary.dto.ts',
    content: '// Placeholder\n',
  },
  {
    relativePath:
  ...
  {
    relativePath:
      'libs/core/application/tenancy/src/lib/ports/user-provisioning.service.port.ts',
    content: '// Placeholder\n',
  },
];
...
async function createPlaceholderFiles(): Promise<void> {
  ...
  for (const file of filesToCreate) {
    ...
    try {
      ...
      const fileContent =
        file.content !== undefined ? file.content : `// ${file.relativePath}\n`;
