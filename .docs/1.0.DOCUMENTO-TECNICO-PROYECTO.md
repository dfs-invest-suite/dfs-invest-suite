...
Capa de Aplicaciones (Apps - apps/*):
...
Capa de Adaptadores de Infraestructura (libs/infrastructure/*):
...
Capa de Aplicación (libs/core/application/*):
...
Capa de Dominio (libs/core/domain/*):
