...
[
  ...
  Impacto:
    - Modificación de `ExceptionBase` y `SerializedException` para usar genéricos.
    - Las clases de excepción hijas necesitarían especificar su tipo de metadata.
]
[
...
31. Archivo: libs/core/application/tenancy/src/lib/ports/database-provisioning.service.port.ts
